...
const Output = ({ data }) => {
  ...
  if (data)
    return (
      <>
        <main className="flex flex-col gap-8 rounded-xl p-4 dark:bg-lightBlack">
          <div className="flex gap-2">
            <img
              className="h-fit w-20 rounded-full object-contain"
              src={data.avatar_url}
            />
          ...
          <div className="flex justify-evenly gap-2 rounded-lg p-4 dark:bg-black">
