    ...
    return (
      <>
        <main className="flex flex-col gap-8 rounded-xl bg-white px-5 py-8 dark:bg-lightBlack">
          ...
          <div className="flex justify-evenly gap-2 rounded-lg bg-darkWhite p-5 dark:bg-black">
          ...
          <ul className="flex flex-col gap-4">
              ...
              svg={
                <svg height="20" width="14" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    className={`${data.location === null ? "fill-darkWhite dark:fill-grayBlue" : "fill-grayBlue dark:fill-white"}`}
                  />
                </svg>
              }
            />
            <DataItem
              ...
              svg={
                <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                  <g
                    className={`${data.blog === null ? "fill-darkWhite dark:fill-grayBlue" : "fill-grayBlue dark:fill-white"}`}
                  >
              ...
              svg={
                <svg height="18" width="20" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    className={`${data.twitter_username === null ? "fill-darkWhite dark:fill-grayBlue" : "fill-grayBlue dark:fill-white"}`}
                  />
                </svg>
              }
            />
            <DataItem
              ...
              svg={
                <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                  <g
                    className={`${data.company === null ? "fill-darkWhite dark:fill-grayBlue" : "fill-grayBlue dark:fill-white"}`}
                  >
