const Input = ({ onSubmit, username, setUsername, error }) => {
  return (
    <>
      ...
      >
        <input
          className="flex w-full bg-search bg-mobile bg-left bg-no-repeat pl-8 placeholder:text-sm focus:outline-none dark:bg-lightBlack dark:placeholder:text-white"
          value={username}
