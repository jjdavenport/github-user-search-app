const Input = ({ onSubmit, username, setUsername }) => {
  return (
    <>
      ...
      >
        <input
          className={`${username === "Not found!" ? "text-red-600" : "text-darkBlue dark:text-darkWhite"} flex w-full bg-search bg-mobile bg-left bg-no-repeat focus:outline-none ~sm/md:~pl-8/10 ~sm/lg:~text-base/lg ~sm/lg:placeholder:~text-sm/lg dark:bg-lightBlack dark:placeholder:text-darkWhite`}
          value={username}
