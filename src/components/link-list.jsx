...
const LinkList = ({ data }) => {
  return (
    <>
      <ul className="flex flex-col ~sm/md:~gap-4/3 md:grid md:grid-cols-2 md:grid-rows-2 lg:gap-x-6">
        <DataItem
          data={data.location}
          svg={
        ...
        <DataLink
          ...
          svg={
            <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
              <g
                className={`${data.blog === null || data.blog === "" ? "fill-darkWhite dark:fill-grayBlue" : "fill-grayBlue dark:fill-white"}`}
              >
